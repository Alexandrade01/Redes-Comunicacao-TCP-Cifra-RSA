...
if __name__ == "__main__":
    print("\n\n######################")
    print(f"{agora()} - Cliente iniciado...")
    # Configurações do Client (Alice)
    serverName = "10.1.70.22"#"10.1.70.15" # Server IP Address
    serverPort = 1300
    ...
    # HANDSHAKE - Chaves públicas recebida do servidor (Bob)
    public_key = json.loads(str(clientSocket.recv(65000),"utf-8"))
    print(f"Chaves públicas (e, n):\n{public_key}\n")
    ...
    clientSocket.send(encrypted_message_utf8.encode('utf-8'))
    print(f"Mensagem criptografada: {encrypted_message_utf8}\n")

    # DEBUG
    # Descriptografar a mensagem
    #decrypted_message = decrypt_rsa(private_key, encrypted_message_utf8)
